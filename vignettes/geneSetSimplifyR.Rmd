...
#install.packages("/Users/chiaoyuhsieh/Downloads/Projects/geneSetSimplifyR", repos = NULL, type="source", INSTALL_opts="--no-multiarch")
devtools::load_all()
```
...
### The optional data have both enrichme
```
